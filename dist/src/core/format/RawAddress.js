...
RawAddress.publicKeyToAddress = (publicKey, networkType) => {
    ...
    decodedAddress[0] = (networkType >> 8) & 0xff;
    decodedAddress[1] = networkType & 0xff;
    RawArray_1.RawArray.copy(decodedAddress, ripemdHash, RawAddress.constants.sizes.ripemd160, 2);
    // step 4: concatenate (3) and the checksum of (3)
    const hash = js_sha3_1.sha3_256.arrayBuffer(decodedAddress.subarray(0, RawAddress.constants.sizes.ripemd160 + 2));
    RawArray_1.RawArray.copy(decodedAddress, RawArray_1.RawArray.uint8View(hash), RawAddress.constants.sizes.checksum, RawAddress.constants.sizes.ripemd160 + 2);
