...
class SecretProofTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded
            ? bitxor_catbuffer_typescript_1.EmbeddedSecretProofTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload))
            : bitxor_catbuffer_typescript_1.SecretProofTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
     ...
     */
    createBuilder() {
        const transactionBuilder = new bitxor_catbuffer_typescript_1.SecretProofTransactionBuilder(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.SECRET_PROOF.valueOf(), new bitxor_catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new bitxor_catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), new bitxor_catbuffer_typescript_1.UnresolvedAddressDto(this.recipientAddress.encodeUnresolvedAddress(this.networkType)), new bitxor_catbuffer_typescript_1.Hash256Dto(this.getSecretByte()), this.hashAlgorithm.valueOf(), this.getProofByte());
    ...
    toEmbeddedTransaction() {
        return new bitxor_catbuffer_typescript_1.EmbeddedSecretProofTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.SECRET_PROOF.valueOf(), new bitxor_catbuffer_typescript_1.UnresolvedAddressDto(this.recipientAddress.encodeUnresolvedAddress(this.networkType)), new bitxor_catbuffer_typescript_1.Hash256Dto(this.getSecretByte()), this.hashAlgorithm.valueOf(), this.getProofByte());
    }
    /**
     * @internal
