...
class VrfKeyLinkTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded
            ? bitxor_catbuffer_typescript_1.EmbeddedVrfKeyLinkTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload))
            : bitxor_catbuffer_typescript_1.VrfKeyLinkTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
     ...
     */
    createBuilder() {
        const transactionBuilder = new bitxor_catbuffer_typescript_1.VrfKeyLinkTransactionBuilder(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.VRF_KEY_LINK.valueOf(), new bitxor_catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new bitxor_catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), new bitxor_catbuffer_typescript_1.PublicKeyDto(format_1.Convert.hexToUint8(this.linkedPublicKey)), this.linkAction.valueOf());
    ...
    toEmbeddedTransaction() {
        return new bitxor_catbuffer_typescript_1.EmbeddedVrfKeyLinkTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.VRF_KEY_LINK.valueOf(), new bitxor_catbuffer_typescript_1.PublicKeyDto(format_1.Convert.hexToUint8(this.linkedPublicKey)), this.linkAction.valueOf());
    }
    /**
     * @internal
     * @returns {VrfKeyLinkTransaction}
