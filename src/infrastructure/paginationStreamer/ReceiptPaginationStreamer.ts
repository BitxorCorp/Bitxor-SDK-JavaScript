...
export class ReceiptPaginationStreamer {
     ...
     * @return a new Pagination Streamer.
     */
    public static tokenResolutionStatements(
        repository: ReceiptRepository,
    ): PaginationStreamer<TokenIdResolutionStatement, ResolutionStatementSearchCriteria> {
        return new PaginationStreamer<TokenIdResolutionStatement, ResolutionStatementSearchCriteria>({
            search(criteria: ResolutionStatementSearchCriteria): Observable<Page<TokenIdResolutionStatement>> {
