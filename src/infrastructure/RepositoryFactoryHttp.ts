...
import { RestrictionTokenHttp } from './RestrictionTokenHttp';
...
export class RepositoryFactoryHttp implements RepositoryFactory {
    ...
    createTokenRepository(): TokenRepository {
        return new TokenHttp(this.url, this.networkType, this.fetchApi);
    }
    ...
    createRestrictionTokenRepository(): RestrictionTokenRepository {
        return new RestrictionTokenHttp(this.url, this.fetchApi);
    }
