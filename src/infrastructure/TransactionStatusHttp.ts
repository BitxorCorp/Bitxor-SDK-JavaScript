...
import { TransactionStatusDTO, TransactionStatusRoutesApi } from 'bitxor-openapi-typescript-fetch-client';
...
export class TransactionStatusHttp extends Http implements TransactionStatusRepository {
    /**
     * @internal
     * Bitxor openapi typescript-node client transaction status routes api
     */
