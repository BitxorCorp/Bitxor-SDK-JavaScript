...
import { BlockInfoDTO, BlockRoutesApi, ImportanceBlockDTO } from 'bitxor-openapi-typescript-fetch-client';
import { Observable } from 'rxjs';
import { DtoMapping } from '../core/utils/DtoMapping';
import { PublicAccount } from '../model/account/PublicAccount';
import { BlockInfo } from '../model/blockchain/BlockInfo';
import { BlockType } from '../model/blockchain/BlockType';
import { GenesisImportanceBlockInfo } from '../model/blockchain/GenesisImportanceBlockInfo';
...
export class BlockHttp extends Http implements BlockRepository {
    /**
     * @internal
     * Bitxor openapi typescript-node client block routes api
     */
    ...
    private toBlockInfo(dto: BlockInfoDTO): BlockInfo {
        ...
        if (blockType === BlockType.NormalBlock.valueOf()) {
            return normalBlock;
        } else if ([BlockType.ImportanceBlock.valueOf(), BlockType.GenesisBlock.valueOf()].includes(blockType)) {
