...
import { FinalizationProofDTO, FinalizationRoutesApi } from 'bitxor-openapi-typescript-fetch-client';
...
export class FinalizationHttp extends Http implements FinalizationRepository {
    /**
     * @internal
     * Bitxor openapi typescript-node client Finalization routes api
     */
