...
import { AccountInfoDTO, AccountRoutesApi } from 'bitxor-openapi-typescript-fetch-client';
...
import { Token, TokenId } from '../model/token';
...
export class AccountHttp extends Http implements AccountRepository {
    ...
    public static toAccountInfo(dto: AccountInfoDTO): AccountInfo {
        return new AccountInfo(
            ...
            dto.account.tokens.map((tokenDTO) => new Token(new TokenId(tokenDTO.id), UInt64.fromNumericString(tokenDTO.amount))),
