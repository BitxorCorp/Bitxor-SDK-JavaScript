...
export class AccountRestriction {
    ...
    constructor(
         ...
         */
        public readonly restrictionFlags: AddressRestrictionFlag | TokenRestrictionFlag | OperationRestrictionFlag,
        /**
         * Restriction values.
         */
        public readonly values: (Address | TokenId | TransactionType)[],
    ) {}
}
