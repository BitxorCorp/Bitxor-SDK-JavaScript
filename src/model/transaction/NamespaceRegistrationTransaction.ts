...
import { NamespaceTokenIdGenerator } from '../../infrastructure/transaction';
...
export class NamespaceRegistrationTransaction extends Transaction {
    ...
    public static createSubNamespace(
        ...
        if (typeof parentNamespace === 'string') {
            parentId = new NamespaceId(NamespaceTokenIdGenerator.subnamespaceParentId(parentNamespace, namespaceName));
        } else {
            parentId = parentNamespace;
        }
        const namespaceId =
            typeof parentNamespace === 'string'
                ? new NamespaceId(NamespaceTokenIdGenerator.subnamespaceNamespaceId(parentNamespace, namespaceName))
