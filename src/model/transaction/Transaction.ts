...
import { EmbeddedTransactionBuilder, PublicKeyDto, SignatureDto, TransactionBuilder } from 'bitxor-catbuffer-typescript';
...
export abstract class Transaction {
     ...
     * @var {number}
     */
    public static readonly Header_Size: number = 8 + 64 + 32 + 3;
     ...
     * @var {number}
     */
    public static readonly Type_Index: number = Transaction.Header_Size + 3;
     ...
     * @var {number}
     */
    public static readonly Body_Index: number = Transaction.Header_Size + 1 + 2 + 2 + 8 + 8;
