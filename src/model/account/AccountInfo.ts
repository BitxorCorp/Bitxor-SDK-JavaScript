...
export class AccountInfo {
    ...
    public serialize(): Uint8Array {
        ...
        const balances: TokenBuilder[] = this.tokens.map((m) => AccountInfo.toTokenBuilder(m));
    ...
    private static toTokenBuilder(m: Token): TokenBuilder {
        return new TokenBuilder((m.id as TokenId).toBuilder(), new AmountDto(m.amount.toDTO()));
    }
